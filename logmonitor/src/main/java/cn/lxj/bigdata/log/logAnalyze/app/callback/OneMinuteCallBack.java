...
import cn.lxj.bigdata.log.logAnalyze.app.dao.CacheData;
...
import cn.lxj.bigdata.log.logAnalyze.storm.utils.MyShardedJedisPool;
...
public class OneMinuteCallBack implements Runnable {
    ...
    private List<BaseRecord> getAppData(List<BaseRecord> baseRecordList) {
        ...
        for (BaseRecord baseRecord : baseRecordList) {
            ...
            appendDataList.add(new BaseRecord(baseRecord.getIndexName(), pvAppendValue, uvAppendValue, baseRecord
                    .getProcessTime()));
        }
