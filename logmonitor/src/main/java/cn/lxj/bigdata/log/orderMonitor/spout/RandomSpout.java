...
public class RandomSpout extends BaseRichSpout {
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        products.add(new Product("42077920512", "iphone6手机壳4.7透明超薄硅胶6s苹果", new BigDecimal(10), "配件", new BigDecimal
                (5.2), 1));
        products.add(new Product("42077920513", "iphone6钢化玻璃膜6s苹果6钢化保护", new BigDecimal(14), "配件", new BigDecimal(8),
                1));
        products.add(new Product("42077920514", "iring苹果6s plus指环支架手机通用懒人", new BigDecimal(10), "配件", new BigDecimal
                (4), 1));
        products.add(new Product("42077920515", "苹果5s按键贴home键6plus识别指纹ip", new BigDecimal(8), "配件", new BigDecimal(5)
                , 1));
...
//                String device, String orderType, List< Product > products, BigDecimal totalPrice
        PaymentInfo paymentInfo = new PaymentInfo("1280921834599179", new Date(), "2015112421001001660230384950", new
                Date()
    ...
    public void nextTuple() {
        PaymentInfo paymentInfo = (PaymentInfo) list.get(0);
