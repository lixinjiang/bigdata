...
public class InverIndexStepOne {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputFormat.setInputPaths(job,new Path("E:\\IdeaProjects\\bigdata\\mapreduce\\input\\Inverindex"));
        FileOutputFormat.setOutputPath(job,new Path("E:\\IdeaProjects\\bigdata\\mapreduce\\output\\Inverindex"));
